...
SET(OpenCV_INCLUDE_DIRS /home/christophe/src/install_OpenCV/include/opencv;/home/christophe/src/install_OpenCV/include)
...
SET(OpenCV_LIB_DIR /home/christophe/src/install_OpenCV/lib)
...
IF (NOT 1)
    ...
    LINK_DIRECTORIES(/home/christophe/src/install_OpenCV/lib/../3rdparty/lib)
    if(WIN32)
        LINK_DIRECTORIES(""/3rdparty/lib)
    else()
        LINK_DIRECTORIES(/home/christophe/src/install_OpenCV/lib/../share/opencv/3rdparty/lib)
    endif()    

	set(OpenCV_LIBS dl;m;pthread;rt;tbb  gtk-x11-2.0;gdk-x11-2.0;atk-1.0;gio-2.0;pangoft2-1.0;pangocairo-1.0;gdk_pixbuf-2.0;cairo;pango-1.0;freetype;fontconfig;gobject-2.0;gmodule-2.0;gthread-2.0;rt;glib-2.0;gthread-2.0;rt;glib-2.0;avcodec;avformat;avutil;swscale ${OpenCV_LIBS})

    set(OPENCV_EXTRA_COMPONENTS /usr/lib/i386-linux-gnu/libjpeg.so /usr/lib/i386-linux-gnu/libpng.so;/usr/lib/i386-linux-gnu/libz.so /usr/lib/i386-linux-gnu/libtiff.so /usr/lib/i386-linux-gnu/libjasper.so;/usr/lib/i386-linux-gnu/libjpeg.so zlib opencv_lapack)
